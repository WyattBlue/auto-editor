...
interface v3 {
  ...
  transitions?: {      // Optional edit-point transitions, indexed like v/a.
    v: Transition[][];
    a: Transition[][];
  };
}
...
interface Transition {
  kind: "dissolve";
  at: Natural;         // Edit point in timeline frames.
  dur: Natural;        // Positive transition duration in timeline frames.
